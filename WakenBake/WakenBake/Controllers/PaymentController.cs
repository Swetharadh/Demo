...
namespace razorpaydemo.Controllers
{
    public class PaymentController : Controller
    {
        ...
        public ActionResult CreateOrder(Models.PaymentInitiateModel _requestData)
        {
            ...
            Razorpay.Api.RazorpayClient client = new Razorpay.Api.RazorpayClient("rzp_test_QaV8Ez7jTUCM4P", "1P4DVdyiAv7wMhKiuWvf0mDt");
            ...
            OrderModel orderModel = new OrderModel
            {
                ...
                razorpayKey = "rzp_test_QaV8Ez7jTUCM4P",
